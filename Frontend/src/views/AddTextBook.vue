<template>
      ...
      <div class="col-lg-6">
        <div class="detailbook__information-book">
          ...
          <div class="detailbook__information-book-price-and-info">
            ...
            <input
              type="text"
              placeholder="Nhập giá giáo trình"
              v-model="price"
            />
          ...
          <div class="detailbook__information-book-publishing">
            ...
            <div class="wrapper-faculties d-flex gap-3 align-items-center">
              <select v-model="faculty" name="faculty" required>
  ...
  <div
    ...
    style="
      ...
      z-index: 10000;
    "
    @click.self="showAddFacultyModal = false"
  >
    <div
      style="
        background: white;
      ...
      "
    >
      <h3 style="margin-bottom: 20px; font-size: 2rem">Thêm khoa mới</h3>
      <input
  ...
  methods: {
    ...
    async handleAddTextBook() {
      ...
      try {
        ...
        const response = await bookService.addTextBook(formData);

        alert('Thêm sách giáo trình thành công!');
        ...
        alert('Lỗi khi thêm sách giáo trình: ' + message);
      } finally {
    ...
    async handleAddFaculty() {
      ...
      try {
        ...
        const response = await bookService.addFaculty({
        ...
        this.faculty = this.newFacultyName.trim();

        // Đóng modal và reset
        this.showAddFacultyModal = false;
        this.newFacultyName = '';
      } catch (error) {
        const message = error.response?.data?.message || 'Lỗi khi thêm khoa';
        alert(message);
      } finally {
        this.isLoading = false;
      }
